  ...
  return (
    <>
      <footer className={props.className}>
        <div className="flex flex-col md:gap-10 gap-[60px] items-center justify-center mb-[23px] mt-[76px] w-full">
          <div className="flex md:flex-col flex-row md:gap-10 gap-[87px] items-start justify-center w-auto md:w-full">
            <div className="flex flex-col gap-4 items-start justify-start w-auto">
              ...
              <Input
                ...
                className="!placeholder:text-gray-50_7e !text-gray-50_7e font-poppins p-0 text-base text-left w-full"
              ...
              <div className="flex flex-col gap-6 items-start justify-start w-auto">
                ...
                <div className="flex flex-col gap-2 items-start justify-start w-auto">
                  <Text
                    ...
                    size="txtPoppinsMedium12Gray5099"
                  >
