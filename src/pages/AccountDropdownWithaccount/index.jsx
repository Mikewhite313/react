    ...
    <>
      <div className="bg-white-A700 flex flex-col font-poppins items-center justify-start mx-auto overflow-auto w-full">
        ...
        <ECommerceHomePageHeader
          ...
          hometext="Home"
        />
        <div className="font-poppins md:h-[387px] h-[402px] md:px-5 relative w-full">
          <div className="absolute flex flex-col h-max inset-[0] items-center justify-center m-auto w-full">
            <div className="flex flex-col items-center justify-start w-full">
              <Img
                ...
                alt="lineThree"
              />
              <div className="h-[386px] relative w-[82%] md:w-full">
                <Slider
                  autoPlay
                  ...
                  items={[...Array(15)].map(() => (
                    <React.Fragment key={Math.random()}>
                      <div className="bg-black-900 flex flex-col items-end justify-end mx-2.5 pl-4 pt-4">
                        <div className="h-[328px] relative w-[95%] md:w-full">
                          <div className="h-[328px] inset-y-[0] my-auto right-[0] w-3/5 sm:w-full">
                            <Img
                          ...
                          <div className="absolute flex flex-col gap-5 h-max inset-y-[0] items-start justify-start left-[0] my-auto w-[36%]">
                ...
                />
                <PagerIndicator
                  className="absolute bottom-[3%] flex gap-[11px] h-3.5 items-center justify-center right-[37%] w-[106px]"
                  count={5}
        ...
        <div className="flex flex-col font-poppins items-end mt-[137px] pl-[135px] md:px-5 w-full">
          <div className="flex flex-col gap-10 items-start justify-start w-auto md:w-full">
            ...
            <List
              className="sm:flex-col flex-row gap-[30px] grid sm:grid-cols-1 md:grid-cols-3 grid-cols-5 justify-start w-auto md:w-full"
        ...
        />
        <div className="flex flex-col items-end mt-[61px] md:px-5 px-[254px] w-full">
          <Button
