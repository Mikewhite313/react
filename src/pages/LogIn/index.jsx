    ...
    <>
      <div className="bg-white-A700 flex flex-col font-poppins items-start justify-start mx-auto w-full">
        <div className="flex flex-col items-center w-full">
          ...
          <ECommerceHomePageHeader className="flex md:flex-col flex-row font-inter md:gap-10 gap-[210px] items-center justify-between max-w-[1170px] mt-[38px] mx-auto md:px-5 w-full" />
          <Img
            className="h-px mt-4"
