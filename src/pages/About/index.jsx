    ...
    <>
      <div className="bg-white-A700 flex flex-col font-poppins items-center justify-start mx-auto w-full">
        <div className="flex flex-col items-center justify-start w-full">
          ...
          >
            <div className="border hover:border-0 border-black-900_4c border-solid hover:cursor-pointer flex flex-1 flex-col items-center justify-start p-[30px] sm:px-5 rounded hover:shadow-bs1 hover:w-full w-full">
              <AboutColumnhome className="flex flex-col gap-6 items-center justify-start w-[169px]" />
            </div>
            <div className="bg-red-600 border hover:border-0 border-black-900_4c border-solid hover:cursor-pointer flex flex-1 flex-col items-center justify-end p-[29px] sm:px-5 rounded hover:shadow-bs1 shadow-bs1 hover:w-full w-full">
              <AboutColumniconsale className="flex flex-col gap-6 items-center justify-start mt-0.5 w-auto" />
            </div>
            <div className="border hover:border-0 border-black-900_4c border-solid hover:cursor-pointer flex flex-1 flex-col items-center justify-start p-1 rounded hover:shadow-bs1 hover:w-full w-full">
              <AboutColumniconshoppingbag className="flex flex-col gap-6 items-center justify-start my-[26px] w-[262px]" />
            </div>
            <div className="border hover:border-0 border-black-900_4c border-solid hover:cursor-pointer flex flex-1 flex-col items-center justify-end p-[27px] sm:px-5 rounded hover:shadow-bs1 hover:w-full w-full">
              <AboutColumniconsale
                className="flex flex-col gap-6 items-center justify-start mt-0.5 w-auto"
                saleicon="images/img_iconmoneybag.svg"
              />
            </div>
          </List>
          <List
