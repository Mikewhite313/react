      ...
      <div className="bg-white-A700 flex flex-col font-poppins items-center justify-start mx-auto w-full">
        <div className="flex flex-col items-start justify-start w-full">
          ...
          <div className="flex md:flex-col flex-row font-poppins gap-[30px] items-center justify-start max-w-[1170px] mt-20 mx-auto md:px-5 w-full">
            <div className="bg-white-A700 flex md:flex-1 flex-col items-center justify-start p-[35px] sm:px-5 rounded shadow-bs w-[30%] md:w-full">
            ...
            <div className="bg-white-A700 flex md:flex-1 flex-col items-center justify-start p-[31px] sm:px-5 rounded shadow-bs w-[69%] md:w-full">
